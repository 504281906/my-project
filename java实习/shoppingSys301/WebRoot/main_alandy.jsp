...
<html>
  <head>
    ...
    <style type="text/css">
    	...
    	*/
    	#ol3 li{border: 1px solid red;height: 50px;width: 120px;
  ...
  <body>
    	...
    	<hr>
    	<ol id="ol3">
    		<li >aaaa <a href="#">首页</a></li>
    		<li ><a href="/shoppingSys/index.jsp">用户注册</a></li>
    		<li ><a href="#">用户登陆</a></li>
    		<li><a href="#">我的订单</a></li>
    		<li><a href="/shoppingSys/car.jsp">购物车</a></li>
    		<li><a href="#">搜索</a></li>
    	</ol>
